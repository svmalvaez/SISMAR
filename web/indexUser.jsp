<%-- 
    Document   : indexUser
    Created on : 29-oct-2013, 16:30:52
    Author     : Sergio
--%>
          ...
          <div class="container">
            <div class="navbar-header">
              <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                ...
                <a class="navbar-brand" href="#"><span class="glyphicon glyphicon-user"><%out.print(" "+request.getSession().getAttribute("usuario"));%></span></a>
            </div>
            <div class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                ...
                <li><a href="ServletCerrar">Cerrar Sesión</a></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="item active">
          ...
          <div class="container">
            <div class="carousel-caption">
              <h1><%out.print("Bienvenido "+request.getSession().getAttribute("usuario"));%></h1>
              <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
              <p><a class="btn btn-large btn-primary" href="#perfil">Perfil de Usuario</a></p>
            </div>
          </div>
        </div>
        <div class="item">
